...
namespace Amju
{
SceneNodeGrid::SceneNodeGrid() : m_numDivisions(0), m_sideLength(0)
{
}

void SceneNodeGrid::Build(int numDivs, float len, HeightFunc hf)
{
...
void SceneNodeGrid::RecalcNormals(HeightFunc hf)
{
  if (hf)
  {
...
void SceneNodeGrid::Rebuild(HeightFunc hf)
{
  // Calc normals first
