...
/*!**************************************************************************
 ...
 @details       This function should be called "regularly"; two use cases are
                ...
                Changing the Active HW Group: the API is designed to allow the
				HW group to be changed immediately after gathering a reading.
				Typically the group ID should be 0xffffffff in order to leave
				the active group unchanged; if it is desired to change it then
				pass the new group ID.
****************************************************************************/
