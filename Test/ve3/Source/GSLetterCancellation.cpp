...
static void StartLC(GuiElement*)
{
...
{
  return TheGSLetterCancellation::Instance()->OnCursorEvent(ce);
}

bool LCListener::OnMouseButtonEvent(const MouseButtonEvent& mbe)
{
  return TheGSLetterCancellation::Instance()->OnMouseButtonEvent(mbe);
}

GSLetterCancellation::GSLetterCancellation()
{
...
bool GSLetterCancellation::OnCursorEvent(const CursorEvent& ce)
{
...
bool GSLetterCancellation::OnMouseButtonEvent(const MouseButtonEvent& mbe)
{
  if (mbe.isDown)
  {
    return false;
...
void GSLetterCancellation::StartTest()
{
