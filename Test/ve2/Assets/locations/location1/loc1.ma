...
//Name: loc1.ma
//Last modified: Sun, Mar 10, 2013 07:37:21 AM
//Codeset: UTF-8
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -682.27253769657966 3006.7881943157372 1546.2160633590652 ;
	setAttr ".r" -type "double3" -66.938352729603864 1.800000000000463 -4.9720701062415276e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 3477.8501987622049;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.011688232421875 -0.27645298838615417 -80.573410034179688 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -19.237269426792182 664.46943994485241 746.35885778741113 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 4888.6032749364804;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "loc1:pCube1";
	setAttr ".t" -type "double3" 2.7120394256013469 0 0 ;
	setAttr ".rp" -type "double3" -0.72960815229123455 1.1059600388032749 -13.405211040086556 ;
	setAttr ".sp" -type "double3" -0.72960815229123455 1.1059600388032749 -13.405211040086556 ;
createNode mesh -n "loc1:pCube1Shape" -p "loc1:pCube1";
	setAttr -k off ".v";
	setAttr ".iog[0].og[0].gcl" -type "componentList" 1 "f[0:1]";
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 4 ".uvst[0].uvsp[0:3]" -type "float2" -3.50504804 4.17670918
		 -3.50504804 -3.66554093 3.99387193 4.17670918 3.99387193 -3.66554093;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr -s 4 ".vt[0:3]"  -623.65307617 -0.55290598 363.46969604 623.62969971 -0.55290598 363.46969604
		 -623.65307617 -0.55290598 -411.18414307 623.62969971 -0.55290598 -411.18414307;
	setAttr -s 5 ".ed[0:4]"  2 0 0 0 3 0 3 2 0 0 1 0 1 3 0;
...
createNode transform -n "loc1:pPlane1";
createNode mesh -n "loc1:pPlane1Shape" -p "loc1:pPlane1";
	setAttr -k off ".v";
	setAttr ".iog[0].og[0].gcl" -type "componentList" 1 "f[0:1]";
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 4 ".uvst[0].uvsp[0:3]" -type "float2" 0 0 1 0 0 1.00050604343
		 1 0.99856597;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr -s 4 ".vt[0:3]"  1.081980944 0 -412.65753174 113.59137726 0 -412.65753174
		 1.081980944 0 -524.61651611 113.59137726 0 -524.61651611;
	setAttr -s 5 ".ed[0:4]"  0 1 0 1 2 0 2 0 0 1 3 0 3 2 0;
	setAttr -s 6 ".n[0:5]" -type "float3"  1e+20 1e+20 1e+20 1e+20 1e+20
		 1e+20 1e+20 1e+20 1e+20 0 1 0 0 1 0 0 1 0;
	setAttr -s 2 ".fc[0:1]" -type "polyFaces" 
		f 3 0 1 2
		mu 0 3 0 1 2
		f 3 -2 3 4
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" -882.50269985075454 0 58.404015130405128 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.43187424540519714 0.5 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
...
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" -1461.8673395914348 0 -141.74033415356598 ;
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5 0.48248383402824402 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode transform -n "polySurface1";
	setAttr ".t" -type "double3" 903.99665586796664 0 -216.51156695522877 ;
	setAttr ".rp" -type "double3" -903.99665586796698 -2.2737367544323206e-13 851.33665649701732 ;
	setAttr ".sp" -type "double3" -903.99665586796698 -2.2737367544323206e-13 851.33665649701732 ;
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.50000005960464478 0.32418659329414368 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode file -n "loc1:blinn1SG1F";
	setAttr ".ftn" -type "string" "/Users/jay/projects/amjulib/Test/ve2/Assets/locations/location1/tex1.png";
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 511.79902930604226;
	setAttr ".h" 592.5324904112797;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "/Users/jay/projects/amjulib/Test/ve2/Assets/ground1.png";
createNode place2dTexture -n "place2dTexture1";
createNode polyPlane -n "polyPlane2";
	setAttr ".w" 639.38559979530805;
	setAttr ".h" 616.98644164660118;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
createNode file -n "file2";
	setAttr ".ftn" -type "string" "/Users/jay/projects/amjulib/Test/ve2/Assets/ground2.png";
createNode place2dTexture -n "place2dTexture2";
createNode polyTweakUV -n "polyTweakUV1";
	setAttr ".uopa" yes;
	setAttr -s 4 ".uvtk[0:3]" -type "float2" -1.027468443 -0.99147379
		 1.027468443 -0.99147379 -1.027468443 0.99147379 1.027468443 0.99147379;
createNode polyTweakUV -n "polyTweakUV2";
	setAttr ".uopa" yes;
	setAttr -s 4 ".uvtk[0:3]" -type "float2" -0.70581377 -0.49765617 0.70581383
		 -0.49765617 -0.70581377 0.49765611 0.70581383 0.49765611;
createNode polyTriangulate -n "polyTriangulate1";
	setAttr ".ics" -type "componentList" 1 "f[*]";
createNode polyTriangulate -n "polyTriangulate2";
	setAttr ".ics" -type "componentList" 1 "f[*]";
createNode polyCreateFace -n "polyCreateFace1";
	setAttr -s 8 ".v[0:7]" -type "float3"  -1052.4895 0 585.46271 -666.39191 
		0 590.29462 -469.61679 0 802.93066 -473.32721 0 1051.1824 -751.97791 0 1151.288 -1097.2521 
		0 1140.4373 -1337.6129 0 891.77667 -1331.7185 0 691.72125;
	setAttr ".l[0]"  8;
	setAttr ".tx" 1;
...
createNode file -n "file3";
	setAttr ".ftn" -type "string" "/Users/jay/projects/amjulib/Test/ve2/Assets/bg2.png";
createNode place2dTexture -n "place2dTexture3";
createNode polyTweakUV -n "polyTweakUV3";
	setAttr ".uopa" yes;
	setAttr -s 8 ".uvtk[0:7]" -type "float2" -0.21265203 -0.39277837 0.32705313
		 -0.39277837 0.60579073 -0.099034175 0.60494691 0.24799418 0.21724802 0.39277834 -0.26550645
		 0.38365221 -0.60579067 0.040321499 -0.60105175 -0.23938455;
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 50 80 -ps 2 50 80 -ps 3 50 20 -ps 4 50 20 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Top View\")) \n\t\t\t\t\t\"modelPanel\"\n"
...
connectAttr "loc1:groupId1.id" "loc1:pCube1Shape.iog.og[0].gid";
connectAttr "loc1:blinn1SG.mwc" "loc1:pCube1Shape.iog.og[0].gco";
connectAttr "loc1:groupId2.id" "loc1:pPlane1Shape.iog.og[0].gid";
connectAttr "loc1:lambert4SG.mwc" "loc1:pPlane1Shape.iog.og[0].gco";
connectAttr "polyTriangulate1.out" "pPlaneShape1.i";
connectAttr "polyTweakUV2.uvtk[0]" "pPlaneShape1.uvst[0].uvtw";
connectAttr "polyTriangulate2.out" "pPlaneShape2.i";
connectAttr "polyTweakUV1.uvtk[0]" "pPlaneShape2.uvst[0].uvtw";
connectAttr "polyTriangulate3.out" "polySurfaceShape1.i";
...
connectAttr "loc1:groupId1.msg" "loc1:blinn1SG.gn" -na;
connectAttr "loc1:pCube1Shape.iog.og[0]" "loc1:blinn1SG.dsm" -na;
...
connectAttr "loc1:groupId2.msg" "loc1:lambert4SG.gn" -na;
connectAttr "loc1:pPlane1Shape.iog.og[0]" "loc1:lambert4SG.dsm" -na;
...
connectAttr "polyTweakUV1.out" "polyTriangulate2.ip";
...
connectAttr "polyCreateFace1.out" "polyTweakUV3.ip";
